...
- It is possible to select from a list the individual entities to include in the individual entities white or black list. Select by name, id or entity_id.
- It is possible to select from a list the devices to include in the device white or black list. Select by name or id.
